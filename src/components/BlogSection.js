...
var BlogSection = function () {
    ...
    return (_jsxs("section", { className: "bg-white p-8", children: [_jsx("h2", { className: "text-3xl font-bold mb-8 text-center text-gray-800", children: "Derniers Articles" }), _jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: mainArticles.map(function (article, index) { return (_jsxs(motion.div, { className: "bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300", whileHover: { scale: 1.05 }, children: [article.isVideo ? (_jsxs("video", { controls: true, className: "w-full h-64 object-cover rounded-t-lg", children: [_jsx("source", { src: article.image, type: "video/mp4" }), "Your browser does not support the video tag."] })) : (_jsx("img", { src: article.image, alt: article.title, className: "w-full h-64 object-cover rounded-t-lg" })), _jsxs("div", { className: "p-6", children: [_jsx("h3", { className: "text-xl font-semibold mb-4 text-gray-900", children: article.title }), _jsx(Link, { to: "/blog#".concat(article.slug), className: "text-blue-500 hover:underline", children: "Voir tous les conseils" })] })] }, index)); }) })] }));
};
