...
var AccommodationServicesSection = function () {
    var _a = useState('daily'), selectedDuration = _a[0], setSelectedDuration = _a[1];
    var activities = [
        {
            title: "Cours de Surf",
    ...
    var formatPrice = function (pricing) {
        var prices = {
            daily: "".concat(pricing.daily, "\u20AC/jour"),
            weekly: "".concat(pricing.weekly, "\u20AC/semaine (-").concat(Math.round((1 - pricing.weekly / (pricing.daily * 7)) * 100), "%)"),
            monthly: "".concat(pricing.monthly, "\u20AC/mois (-").concat(Math.round((1 - pricing.monthly / (pricing.daily * 30)) * 100), "%)")
        };
        return prices[selectedDuration];
    };
    var renderMedia = function (media) {
        var isVideo = media.endsWith('.mp4');
        if (isVideo) {
    ...
    return (_jsx("div", { className: "bg-white py-16", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h2", { className: "text-2xl font-bold text-center mb-4", children: "Choisissez votre dur\u00E9e de s\u00E9jour" }), _jsx("div", { className: "flex justify-center", children: _jsxs("div", { className: "inline-flex rounded-lg shadow-sm", children: [_jsx("button", { onClick: function () { return setSelectedDuration('daily'); }, className: "px-4 py-2 text-sm font-medium rounded-l-lg transition-colors ".concat(selectedDuration === 'daily' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'), children: "Journalier" }), _jsx("button", { onClick: function () { return setSelectedDuration('weekly'); }, className: "px-4 py-2 text-sm font-medium border-x transition-colors ".concat(selectedDuration === 'weekly' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'), children: "Hebdomadaire" }), _jsx("button", { onClick: function () { return setSelectedDuration('monthly'); }, className: "px-4 py-2 text-sm font-medium rounded-r-lg transition-colors ".concat(selectedDuration === 'monthly' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'), children: "Mensuel" })] }) })] }), _jsxs("div", { className: "mb-16", children: [_jsxs("div", { className: "flex items-center justify-center gap-2 mb-8", children: [_jsx(Home, { className: "w-8 h-8 text-blue-500" }), _jsx("h2", { className: "text-4xl font-bold text-center", children: "H\u00E9bergements" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: accommodations.map(function (accommodation, index) { return (_jsxs("div", { className: "bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow", children: [renderMedia(accommodation.image), _jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-4", children: [_jsx("h3", { className: "text-xl font-bold", children: accommodation.title }), _jsx("span", { className: "text-blue-500 font-bold", children: formatPrice(accommodation.pricing) })] }), _jsx("p", { className: "text-gray-600 mb-4", children: accommodation.description }), _jsx("div", { className: "flex flex-wrap gap-2", children: accommodation.features.map(function (feature, idx) { return (_jsx("span", { className: "bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full", children: feature }, idx)); }) })] })] }, index)); }) })] }), _jsxs("div", { className: "mb-16", children: [_jsxs("div", { className: "flex items-center justify-center gap-2 mb-8", children: [_jsx(Car, { className: "w-8 h-8 text-blue-500" }), _jsx("h2", { className: "text-4xl font-bold text-center", children: "Transport" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: services.transport.map(function (item, index) { return (_jsxs("div", { className: "bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow", children: [_jsx("h3", { className: "text-xl font-bold mb-2", children: item.title }), _jsx("p", { className: "text-blue-500 font-bold mb-2", children: formatPrice(item.pricing) }), _jsx("p", { className: "text-gray-600", children: item.description })] }, index)); }) })] }), _jsxs("div", { className: "mb-16", children: [_jsxs("div", { className: "flex items-center justify-center gap-2 mb-8", children: [_jsx(Waves, { className: "w-8 h-8 text-blue-500" }), _jsx("h2", { className: "text-4xl font-bold text-center", children: "Mat\u00E9riel de Surf" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: services.surfing.map(function (pack, index) { return (_jsxs("div", { className: "group relative bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-1", children: [_jsxs("div", { className: "p-6 relative z-10", children: [_jsx("h3", { className: "text-xl font-bold mb-2 transition-colors duration-300 group-hover:text-blue-600", children: pack.title }), _jsx("p", { className: "text-blue-500 font-bold mb-4", children: formatPrice(pack.pricing) }), _jsx("ul", { className: "list-disc list-inside text-gray-600", children: pack.items.map(function (item, idx) { return (_jsx("li", { className: "transition-colors duration-300 group-hover:text-gray-800", children: item }, idx)); }) })] }), _jsx("div", { className: "absolute inset-0 opacity-7 group-hover:opacity-20 transition-opacity duration-300", children: _jsx("img", { src: pack.image, alt: pack.title, className: "w-full h-full object-cover" }) }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-white via-white to-transparent opacity-0 group-hover:opacity-90 transition-opacity duration-300" })] }, index)); }) })] }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-center gap-2 mb-8", children: [_jsx(Compass, { className: "w-8 h-8 text-blue-500" }), _jsx("h2", { className: "text-4xl font-bold text-center", children: "Activit\u00E9s " })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: services.activities.map(function (activity, index) { return (_jsxs("div", { className: "bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2", children: [_jsxs("div", { className: "flex items-center mb-4", children: [_jsx("div", { className: "bg-blue-100 p-3 rounded-full mr-4", children: activity.icon }), _jsx("h3", { className: "text-xl font-bold", children: activity.title })] }), _jsx("p", { className: "text-blue-500 font-bold mb-2", children: formatPrice(activity.pricing) }), _jsx("p", { className: "text-gray-600", children: activity.description })] }, index)); }) })] })] }) }));
};
