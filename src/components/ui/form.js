...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx("p", __assign({ ref: ref, id: formDescriptionId, className: cn("text-[0.8rem] text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx("p", __assign({ ref: ref, id: formMessageId, className: cn("text-[0.8rem] font-medium text-destructive", className) }, props, { children: body })));
});
